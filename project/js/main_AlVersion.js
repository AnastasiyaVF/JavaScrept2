...
class Product {
	...
	getSum (){ //суммарная стоимость товара в корзине
        // let Sum = 0;
        // this.product.forEach (product => Sum += price);
        // return Sum;}
        // }
        let Sum = this.product.reduce((total, now) => {
            return total + now
        }, 0);
    }
}

let totalSum = `"Товары на сумму" + ${Sum}`;
